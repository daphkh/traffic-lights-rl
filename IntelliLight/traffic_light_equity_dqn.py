...
from deeplight_equity_agent import DeeplightEquityAgent

from sumo_agent import SumoAgent
import xml.etree.ElementTree as ET


class TrafficLightEquityDQN:

    DIC_AGENTS = {
        "DeeplightEquity": DeeplightEquityAgent,
    }
...
def main(memo, f_prefix, sumo_cmd_str, sumo_cmd_str_gui, sumo_cmd_pretrain_str, sumo_cmd_pretrain_str_gui):
    ...
    player = TrafficLightEquityDQN(memo, f_prefix)
